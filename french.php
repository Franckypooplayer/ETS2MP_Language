...
$_lang["facebook.advertisement"] = "Les dernières nouvelles sur notre page Facebook.";
...
$_lang["error.cannot.fetch.steam.api"] = "Impossible de se connecter à l'API de steam, veuillez ré-éssayer plus tard.";
$_lang["remember.me"] = "Se rappeler de moi";
$_lang["news.is.not.visible.anymore"] = "L'information n'est plus visible";
$_lang["could.not.make.the.news.invisible"] = "Ne pas pouvoir rendre l'information invisible";
$_lang["we.are.displaying.the.news"] = "Information(s) disponible(s)";
$_lang["could.not.display.the.news"] = "Ne pas afficher d'information(s)";
$_lang["news.added"] = "Information(s)s ajoutée(s)";
$_lang["could.not.add.the.news"] = "Impossible d'afficher une information";
$_lang["writted.by"] = "Ecrit par";
$_lang["message"] = "Message";
$_lang["posted.at"] = "Publié par";
$_lang["hide.show"] = "Masquer Afficher";
$_lang["hide"] = "Masquer";
$_lang["show"] = "Afficher";
$_lang["you.do.not.have.access.to.this.page"] = "Vous n'avez pas accès à cette page";
$_lang["name"] = "Nom";
$_lang["rank"] = "Grade";
$_lang["status"] = "Statut";
$_lang["error.try.again"] = "erreur, ré-éssayer";
$_lang["not.connected"] = "Non connecté";
$_lang["not.banned"] = "Vous n'êtes actuellement pas banni";
$_lang["ban.appeal"] = "Demande de suppression de ban";
$_lang["power.revoked"] = "Vos droits ont été enlevés";
$_lang["ban.appeal.sent"] = "Demande de suppression de ban envoyée";
$_lang["could.not.submit.ban.appeal"] = "Impossible de soumettre votre demande de suppression de ban";
$_lang["your.in.game.name.when.banned"] = "Votre nom en jeu lorque vous avez été banni";
$_lang["why.should.you.be.unbanned"] = "Pourquoi devriez-vous être débanni?";
$_lang["screenshot.video.if.applicable"] = "Photos ou vidéos prouvant appuyer votre demande";
$_lang["can.not.send.ban.appeal"] = "Impossible d'envoyer votre demande de suppresion de ban";
$_lang["status.change"] = "Votre staut a été modifié";
$_lang["banned"] = "Vous êtes banni";
$_lang["unban"] = "Vous n'êtes pas banni";
$_lang["could.not.change.status"] = "Impossible de modifier votre statut";
$_lang["comment.added"] = "Commentaire(s) ajouté(s)";
$_lang["comment.could.not.be.added"] = "Impossible d'ajouter de(s) commentaire(s)";
$_lang["comment.deleted"] = "Commentaire(s) supprimé(s)";
$_lang["comment.edited"] = "Commentaire(s) modifié(s)";
$_lang["ban.appeal.information"] = "Information sur votre demande de suppression de ban";
$_lang["ban.appeal.accept.decline"] = "Demande de suppression de ban acceptée, refusée";
$_lang["ban.appeal.must.comment"] = "Vous devez ajouter un commentaire";
$_lang["ban.expiry"] = "Ban expiré";
$_lang["ban.on.system"] = "Informations sur votre ban dans notre base de données";
$_lang["comment.has.been.disable"] = "Les commentaire ont été désactivés";
$_lang["view.ban.appeal.list"] = "Voir la liste des demandes de suppression de ban";
$_lang["manage"] = "Gérer";
$_lang["home"] = "Accueil";
$_lang["reminder.must.wait.three.days"] = "Rappellez vous que vous devez patienter 3 jours";
$_lang["create.ban.appeal"] = "Créer une demande de suppression de ban";
$_lang["view.my.ban.appeal"] = "Voir ma demande de suppression de ban";
$_lang["forum.log"] = "Log du forum";
$_lang["not.enough.permissions"] = "Plus de droits";
$_lang["speed.hack"] = "Speedhack, contournement de la vitesse autorisée sur le serveur";
$_lang["must.log.in"] = "Vous devez être connécté";
$_lang["ban.appeal.must.be.english"] = "toute demande de suppression de ban doit être rédigée en anglais";
